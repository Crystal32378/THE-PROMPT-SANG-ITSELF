# THE PROMPT SANG ITSELF

We wrote instructions for a score. Then the instructions became the score.
...
This piece is a small record of a recursive accident: an instruction was meant to describe music, but the music model sang the instruction instead.
